...
r1 = 4.5;
T1mapunits = T1map./1000;
R1 = 1./(T1mapunits); %in 1/seconds
R1(T1mapunits(:)==0) = 0;
...
for i = 1:91
    for t = 1:30
        T10matching = T1mapunits(artery(AIFSI_index(i),1),artery(AIFSI_index(i),2),artery(AIFSI_index(i),3)); %choose corresponding T1 value  v
